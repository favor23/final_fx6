...
<section class="main_section">
	<section class="main_wrap">
		...
		<table class="table">
		<tr><td>상품</td><td>상품 금액</td><td>총금액</td></tr>
		<tr>
		<td>
			<c:forEach items="${sessionScope.basket}" var="menu">						
					${menu.menu_name}	<br>						
			</c:forEach>
		</td>				
		<td>
		...
		<input type="hidden" id="totalpay" name="totalpay" value="11000">
		</div>		
		<hr>
